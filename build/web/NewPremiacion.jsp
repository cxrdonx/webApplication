<%-- 
    Document   : crudPremiacion
    Created on : 25/10/2020, 15:44:00
    Author     : mared
--%>
    ...
    <a class="dropdown-item" href="NewSubCategoria.jsp">Sub categorias</a>
       ...
       <a class="dropdown-item" href="NewDeportista.jsp">Deportista</a>
        ...
        <div class="form-group">
            <div class="4-options">
                <form action="srvNewPremiacion" method="POST">
                  ...
                  <div class="form-group">
                   <label>Descripcion:</label>
                       <input type="text" class="form-control" placeholder="Descripcion" name="txtDescripcion">
                               ...
                               <div class="form-group">
                           <label >Lugar:</label>
                       <input type="text" class="form-control" placeholder="ingrese el lugar" name="txtLugar">
