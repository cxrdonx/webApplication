<%-- 
    ...
    Created on : 28/10/2020, 18:37:51
    Author     : mared
--%>
    ...
    <a class="dropdown-item" href="NewSubCategoria.jsp">Sub categorias</a>
       ...
       <a class="dropdown-item" href="NewDeportista.jsp">Deportista</a>
        ...
        <div class="form-group">
            <div class="4-options">
                <form action="srvNewCategoria" method="POST">
                    <label>Ingresar una nueva Categoria:</label>
            ...
            <a href="actualizarCategoria.jsp" class="btn btn-outline-dark">Actualizar</a>
            <a href="delCategoria.jsp" class="btn btn-outline-dark" name="btnUpdate">Eliminar</a>
                </div>
          </form>
                    </div>  
