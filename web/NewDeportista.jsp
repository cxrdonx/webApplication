<%-- 
    Document   : newDeportista
    Created on : 31/10/2020, 12:53:40
    Author     : mared
--%>
    ...
    <a class="dropdown-item" href="NewSubCategoria.jsp">Sub categorias</a>
       ...
       <a class="dropdown-item" href="NewDeportista.jsp">Deportista</a>
        ...
        <div class="form-group">
            <div class="4-options">
                <form action="srvNewDeportista" method="POST">
                    
                    <p>  <label> seleccione el deportista:</label>  </p>
                    <select>
                        <option></option>
                    </select>
                    
                      <p>  <label> seleccione el usuario:</label>  </p>
                    <select>
                        <option></option>
                    </select>
                      
                        <p>  <label> seleccione el deporte:</label>  </p>
                    <select>
                        <option></option>
                    </select>
