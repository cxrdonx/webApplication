  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="NewSubCategoria.jsp">Sub categorias</a>
       ...
       <a class="dropdown-item" href="NewDeportista.jsp">Deportista</a>
            ...
            <div class="4-options">
                <form action="srvNewEvento" method="POST">
                    <label>Ingresar un nuevo Evento:</label>
                    <p><label>Evento:</label></P>
                 
               
                       </select>
                       </form>
                       <select name="mostrarIdEv">
                           <option></option>
                          </select>
                    ...
                    <p><label>Deporte:</label></P>
                       ...
                       <select name="mostrarIdDep">
                           <option></option>
                       </select>
                    
                    <p><label>Premiacion:</label></P>
              
               
                       </select>
                       </form>
                       <select name="mostraridPrem">
                           <option></option>
                       </select>
                  ...
                  <div class="form-group">
                   <label>Lugar:</label>
                       <input type="text" class="form-control" placeholder="Ingrese el lugar" name="txtDescripcion">
