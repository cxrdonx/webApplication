  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <a class="dropdown-item" href="NewSubCategoria.jsp">Sub categorias</a>
       ...
       <a class="dropdown-item" href="NewDeportista.jsp">Deportista</a>
            ...
            <div class="4-options">
                <form action="srvNewInscripcion" method="POST">
                    <label>Ingresar una nueva inscripcion:</label>
                    <p><label>Inscripcion:</label></P>
                       </select>
                       </form>
                       <select name="mostrarInscripcion">
                           <option></option>
                       </select>
                 ...
                 <p><label>Usuario:</label></P>
                       ...
                       <select name="mostrarIdUsuario">
                           <option></option>
                       </select>
                       
                       
                 <p><label>Evento:</label></P>
                       </select>
                       </form>
                       <select name="mostrarIdUsuario">
                           <option></option>
                 ...
                 <p><label>Deportista:</label></P>
                  ...
                  <div class="form-group">
                   <label>Precio del evento:</label>
                       <input type="text" class="form-control" placeholder="Ingrese el precio del evento" name="txtPrecio">
             
                </div>
                          <div class="form-group">
                          <label >Fecha:</label>
                       <input type="text" class="form-control" placeholder="ingrese la fecha" name="txtFecha">
